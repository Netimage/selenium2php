...
use \Combine\Controllers\Converter\KatalonConverter;

/**
 * Handles CLI commands.
 */
class Katalon extends Base
{
    ...
    {
        print "Katalon2php converts Selenium HTML tests into PHPUnit test case code.";
        print "\n";
        print "\n";
    }
    ...
    {
        print "Usage: katalon2php [switches] Test.html [Test.php]";
        print "\n";
        print "       katalon2php [switches] <directory>";
        print "\n";
        print "\n";
    ...
    protected function convertFilesInSuite($suitePath, $phpFileName)
    {
        ...
        if ($suiteContent) {
            ...
            $result = $this->_converter->convertSuite($suiteContent, $this->_makeTestName($suitePath), $this->_tplFile,
                $dir);
