 ...
 */
class SeleniumIDE3 extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->_converter = new SeleniumIDE3Converter();
    }
    ...
    protected function parseFile($jsonFileName, $phpFileName)
    {
        ...
        if ($jsonContent) {
            ...
            $result = $this->_converter->convertJSON($jsonContent, $this->_makeTestName($this->_suiteReference),
                $this->_tplFile, $dir);
